...
/**
 * This is the ActiveQuery class for [[UserLoginHistory]].
 *
...
class UserLoginHistoryQuery extends \yii\db\ActiveQuery
{
    ...
    /*public function active()
    {
        return $this->andWhere(['status' => UserLoginHistory::STATUS_PUBLISHED]);
    }*/

    /**
     * @inheritdoc
     * @return UserLoginHistory[]|array
     */
    ...
    /**
     * @inheritdoc
     * @return UserLoginHistory|array|null
     */
